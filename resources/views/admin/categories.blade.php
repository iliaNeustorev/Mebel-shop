    ...
    <hr>
        ...
        <form enctype="multipart/form-data" action="{{ route('add_and_upd_category') }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input required class="form-control w-50" name ='name' placeholder="Введите имя категории" value="{{ $name }}">
            </div>
            ...
            <div class="mb-3">    
                ...
                <textarea required class="form-control w-50" name ='description' row = '3' placeholder="Введите описание категории">{{ $description }}</textarea>
            </div>
        ...
        @if (isset($show_picture))
            <div class="text-center">
                ...
                <br>
                <a href="{{ route('admin_categories') }}"><button class="form-control btn btn-success mt-3 w-50" >Назад</button></a>
            </div>
        @endif
        @if(isset($categories))
